class StickyAddToCart extends HTMLElement {
    constructor() {
        ...
        this.closeSticky = this.querySelector(
            "[data-close-sticky-add-to-cart]"
        );
        this.expandSticky = this.querySelector(
            "[data-expand-sticky-add-to-cart]"
        );
        ...
        if (scrollTop > offsetScroll && scrollTop + winHeight < docHeight) {
            ...
            if (this.sticky.classList.contains("style-1")) {
                ...
                const previewBar =
                    ...
                    toolbarMobile = document.querySelector(
...
class VariantStickyAddToCart extends HTMLElement {
    constructor() {
        ...
        this.updateUnavailableVariant();
        this.toggleBuyPlatform();
    ...
    toggleBuyPlatform() {
        const productForm = document.querySelector(
            `#product-form-sticky-${this.dataset.product}`
        );
        const addButton = productForm.querySelector(
            '#product-sticky-add-to-cart[name="add"]'
        );
